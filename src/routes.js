...
const distributorMaster = React.lazy(() => import('./views/distributor-managment/distributor-master/index'));
const user = React.lazy(() => import('./views/user-managment/user/index'));
const product = React.lazy(() => import('./views/product-managment/product/index'));
const productCategory = React.lazy(() => import('./views/product-managment/product-category/index'));
